    ...
    void iniciarCuentaRegresiva(){
        ...
        StepVerifier
                ...
                .expectNextMatches(domainEvent -> {
                    ...
                    assert event.aggregateRootId().equals("XXXX");
                    return event.getJugadorPrincipal().value().equals("444");
                })
                .expectNextMatches(domainEvent -> {
                    var event = (JugadorAgregado) domainEvent;
                    assert event.aggregateRootId().equals("XXXX");
                    return  event.getJugadorId().value().equals("444");
                })
                .expectNextMatches(domainEvent -> {
                    var event = (JugadorAgregado) domainEvent;
                    assert event.aggregateRootId().equals("XXXX");
                    return  event.getJugadorId().value().equals("222");
                })
                .expectNextMatches(domainEvent -> {
                ...
                .expectNextMatches(domainEvent -> {
                    ...
                    assert event.aggregateRootId().equals("XXXX") && event.getJugadorId().value().equals("444");
                ...
                .expectNextMatches(domainEvent -> {
                    var event = (CartaPuestaEnTablero) domainEvent;
                    assert event.aggregateRootId().equals("XXXX") && event.getJugadorId().value().equals("222");
